...
import com.iktpreobuka.platni_promet_1.repositories.AccountRepository;
import com.iktpreobuka.platni_promet_1.repositories.AddressRepository;
import com.iktpreobuka.platni_promet_1.repositories.BankRepository;
import com.iktpreobuka.platni_promet_1.repositories.ClientRepository;
...
public class BankServiceImpl implements BankService {
	...
	public ResponseEntity<?> modifyBank(Integer id, String name, String pib, String street, String city,
		...
		for (AddressEntity addressI : addressRepository.findAll()) {
			if ((address.getStreet().equalsIgnoreCase(addressI.getStreet()) && address.getCountry().equalsIgnoreCase(addressI.getCountry()))
